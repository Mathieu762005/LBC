    ...
    <main class="container flex-grow-1">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="mb-4 display-3">Bienvenue sur LeBonMarket</h1>
                <p class="lead">Votre plateforme de petites annonces LeBonMarket.</p>
            </div>
            <div class="col-12">
                ...
                <div class="row mt-3">
                    <?php if (is_array($allAnnonce) && count($allAnnonce) > 0): ?>
                    ...
                    <?php else: ?>
                        <div class="col-12">
                            <div class="alert alert-warning" role="alert">
                                Aucune annonce n'a pu être chargée pour le moment.
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
